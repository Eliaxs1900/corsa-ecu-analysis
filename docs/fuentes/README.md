# Fuentes archivadas en local

Copias de seguridad de la documentación externa relevante para el proyecto,
por si los enlaces originales desaparecen.

| Archivo | Qué es | Origen |
|---|---|---|
| `elm327-datasheet.pdf` | **Datasheet oficial completo del ELM327** (82 págs): todos los comandos AT, protocolos, tiempos, init ISO/KWP | cdn.sparkfun.com |
